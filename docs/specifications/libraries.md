...
| Time-signature preset list and parsing in [tracks.md](./tracks.md#time-signature-track-specified)               | [`TimeSignature`](https://tonaljs.github.io/tonal/docs/time/signatures) — `TimeSignature.names()` for the v1 preset list, `TimeSignature.get()` for parsing/validating custom and additive (v2) signatures |
